...
public:
	...
	void clean(const char *pVertexShader_path, const char *pFragmentShader_Path, const char* pGragmentShader_Path);
	void create(const char *pVertexShader_path, const char *pFragmentShader_Path, const char* pGragmentShader_Path);
